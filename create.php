    ...
    if($_SERVER['REQUEST_METHOD'] === 'POST')
    {
        ...
        */
        ...
        if (count($errors)>0)
        {
            ...
            //Effectuons une redirections vers la page de laquelle provient les information
        ...
        <?php endif ?>
                    <form method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="comment" id="create_form_comment" class="form-control" rows="4" value="<?= isset($_SESSION['create_form_old_values']['comment']) ? $_SESSION['create_form_old_values']['comment'] : '' ; unset($_SESSION['create_form_old_values']['comment']); ?>"></textarea >
                        </div>
